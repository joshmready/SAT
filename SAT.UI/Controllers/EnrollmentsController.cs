...
namespace SAT.UI.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            ViewBag.ScheduledClassId = new SelectList(db.ScheduledClasses, "ScheduldedClassId", "InstructorName");
        ...
        public ActionResult Create([Bind(Include = "EnrollmentId,StudentId,ScheduledClassId,EnrollmentDate")] Enrollment enrollment)
        {
            ...
            ViewBag.ScheduledClassId = new SelectList(db.ScheduledClasses, "ScheduldedClassId", "InstructorName", enrollment.ScheduledClassId);
